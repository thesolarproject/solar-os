...
/**
 * 2026-07-15 — Debug session 88eea4: YouTube Save Audio + progress.
 * Layman: tiny JSON breadcrumbs prove why save fails or stalls.
 ...
 */
public final class Debug88eea4Log {

    private static final String TAG = "SolarDbg88eea4";
    private static final String SESSION = "88eea4";
    private static final String FILE = "debug-88eea4.log";
    private static final String INGEST =
            "http://127.0.0.1:7642/ingest/033bd1a9-8f26-4d94-8b67-6b91f340fc87";

    /** On while hunting Save Audio; disable after confirmation. */
    public static volatile boolean ENABLED = false; // 2026-07-16 — off: sync disk/HTTP on wheel/key paths tanked Y1/Y2 scroll

    private Debug88eea4Log() {}
