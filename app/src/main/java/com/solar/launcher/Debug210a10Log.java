...
/**
 * 2026-07-14 — Debug session 210a10: Y1/Y2 portrait NP art size + wheel/button remap.
 * Layman: records cover layout and which keys get rewritten upright.
 ...
 */
public final class Debug210a10Log {

    private static final String TAG = "SolarDbg210a10";
    private static final String SESSION = "210a10";
    private static final String FILE = "debug-210a10.log";
    private static final String INGEST =
            "http://127.0.0.1:7642/ingest/033bd1a9-8f26-4d94-8b67-6b91f340fc87";

    /** 2026-07-14 — On while hunting portrait NP; disable after confirmation. */
    public static volatile boolean ENABLED = false; // 2026-07-16 — off: sync disk/HTTP on wheel/key paths tanked Y1/Y2 scroll

    private Debug210a10Log() {}
