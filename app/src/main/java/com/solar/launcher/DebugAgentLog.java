...
/** Debug-mode NDJSON logger — session 4c96d2; pull via adb from /storage/sdcard0/. */
final class DebugAgentLog {
    private static final String TAG = "SolarDbg4c96d2";
    private static final String FILE = "debug-4c96d2.log";
    private static final String SESSION = "4c96d2";
