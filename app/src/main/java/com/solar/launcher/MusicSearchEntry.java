...
import com.solar.launcher.jellyfin.JellyfinAlbum;
...
/** 2026-07-14: One row in unified Get Music search results (Deezer/Reach/Navidrome/Plex/Jellyfin). */
public final class MusicSearchEntry {
    public enum Source { DEEZER, REACH, NAVIDROME, PLEX, JELLYFIN }

    /** Flat track, Deezer artist/album container, or Reach folder container. */
    public enum RowKind {
        TRACK, DEEZER_ARTIST, DEEZER_ALBUM, REACH_FOLDER, NAVIDROME_ALBUM, PLEX_ALBUM, JELLYFIN_ALBUM
    }
    ...
    public final PlexSong plexSong;
    public final PlexAlbum plexAlbum;
    public final JellyfinSong jellyfinSong;
    public final JellyfinAlbum jellyfinAlbum;
    ...
    private MusicSearchEntry(Source source, RowKind kind, DeezerResult deezer,
            ...
            PlexSong plexSong, PlexAlbum plexAlbum,
            JellyfinSong jellyfinSong, JellyfinAlbum jellyfinAlbum,
        ...
        this.plexSong = plexSong;
        this.plexAlbum = plexAlbum;
        this.jellyfinSong = jellyfinSong;
        this.jellyfinAlbum = jellyfinAlbum;
    ...
    public static MusicSearchEntry deezer(DeezerResult r) {
        return new MusicSearchEntry(Source.DEEZER, RowKind.TRACK, r, null, null, null, null, null, null, null,
                "", null, 0, "");
    }

    public static MusicSearchEntry reach(SoulseekClient.Result r) {
        return new MusicSearchEntry(Source.REACH, RowKind.TRACK, null, r, null, null, null, null, null, null,
                "", null, 0, "");
    }

    public static MusicSearchEntry navidrome(NavidromeSong s) {
        return new MusicSearchEntry(Source.NAVIDROME, RowKind.TRACK, null, null, s, null, null, null, null, null,
                "", null, 0, "");
    }
    ...
    public static MusicSearchEntry navidromeAlbum(NavidromeAlbum album, List<MusicSearchEntry> tracks) {
        ...
        return new MusicSearchEntry(Source.NAVIDROME, RowKind.NAVIDROME_ALBUM, null, null, null, album,
                null, null, null, null, label, tracks, 0, "");
    }

    public static MusicSearchEntry plex(PlexSong s) {
        return new MusicSearchEntry(Source.PLEX, RowKind.TRACK, null, null, null, null, s, null, null, null,
                "", null, 0, "");
    }

    public static MusicSearchEntry plexAlbum(PlexAlbum album, List<MusicSearchEntry> tracks) {
        String label = album != null ? album.name : "";
        if (album != null && album.artist != null && !album.artist.isEmpty()) {
            label = album.name + " · " + album.artist;
        }
        return new MusicSearchEntry(Source.PLEX, RowKind.PLEX_ALBUM, null, null, null, null, null, album,
                null, null, label, tracks, 0, "");
    }

    public static MusicSearchEntry jellyfin(JellyfinSong s) {
        return new MusicSearchEntry(Source.JELLYFIN, RowKind.TRACK, null, null, null, null, null, null, s, null,
                "", null, 0, "");
    }

    public static MusicSearchEntry jellyfinAlbum(JellyfinAlbum album, List<MusicSearchEntry> tracks) {
        String label = album != null ? album.name : "";
        if (album != null && album.artist != null && !album.artist.isEmpty()) {
            label = album.name + " · " + album.artist;
        }
        return new MusicSearchEntry(Source.JELLYFIN, RowKind.JELLYFIN_ALBUM, null, null, null, null, null, null,
                null, album, label, tracks, 0, "");
    }

    public static MusicSearchEntry deezerAlbum(String albumLabel, List<MusicSearchEntry> tracks) {
        return new MusicSearchEntry(Source.DEEZER, RowKind.DEEZER_ALBUM, null, null, null, null, null, null,
                null, null, albumLabel, tracks, 0, "album");
    }

    public static MusicSearchEntry deezerArtist(long artistId, String name) {
        return new MusicSearchEntry(Source.DEEZER, RowKind.DEEZER_ARTIST, null, null, null, null, null, null,
                null, null, name, null, artistId, "");
    }
    ...
    public static MusicSearchEntry deezerAlbumBrowse(long albumId, String label, String recordType,
        ...
        return new MusicSearchEntry(Source.DEEZER, RowKind.DEEZER_ALBUM, null, null, null, null, null, null,
                null, null, label, tracks, albumId, recordType != null ? recordType : "album");
    }

    public static MusicSearchEntry reachFolder(String folderLabel, List<MusicSearchEntry> tracks) {
        return new MusicSearchEntry(Source.REACH, RowKind.REACH_FOLDER, null, null, null, null, null, null,
                null, null, folderLabel, tracks, 0, "");
    }

    public boolean isContainer() {
        return kind == RowKind.DEEZER_ARTIST || kind == RowKind.DEEZER_ALBUM
                || kind == RowKind.REACH_FOLDER || kind == RowKind.NAVIDROME_ALBUM
                || kind == RowKind.PLEX_ALBUM || kind == RowKind.JELLYFIN_ALBUM;
    }
    ...
    public static MusicSearchEntry withChildren(MusicSearchEntry template,
        ...
        return new MusicSearchEntry(template.source, template.kind, template.deezer, template.reach,
                template.navidromeSong, template.navidromeAlbum, template.plexSong, template.plexAlbum,
                template.jellyfinSong, template.jellyfinAlbum, template.containerLabel, children,
    ...
    public String dedupeKey() {
        ...
        if (kind == RowKind.DEEZER_ALBUM || kind == RowKind.REACH_FOLDER || kind == RowKind.NAVIDROME_ALBUM
            ...
            if (plexAlbum != null && plexAlbum.id != null) return "plex:" + plexAlbum.id;
            if (jellyfinAlbum != null && jellyfinAlbum.id != null) return "jf:" + jellyfinAlbum.id;
        ...
        if (source == Source.PLEX && plexSong != null) {
            return normalize(plexSong.artist + " " + plexSong.title);
        }
        if (source == Source.JELLYFIN && jellyfinSong != null) {
            return normalize(jellyfinSong.artist + " " + jellyfinSong.title);
        }
        return "";
    }
