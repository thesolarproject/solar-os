...
/** Last N Deezer search queries in prefs. */
public final class DeezerSearchHistory {
    private static final String PREF_KEY = "deezer_search_history";
    private static final String ENTRY_SEP = "\u001e";
    private static final int MAX_ENTRIES = 50;

    private DeezerSearchHistory() {}
