...
/**
 * 2026-07-05 — Debug session 065122: stuck quick menu + rescue HUD.
 * Pull: adb pull /storage/sdcard0/.solar/debug-065122.log
 */
public final class Debug065122Log {

    private static final String TAG = "SolarDbg065122";
    private static final String SESSION = "065122";
    private static final String FILE = "debug-065122.log";
    /** 2026-07-05 — Off in release; flip true manually for short adb debug sessions. */
    public static volatile boolean ENABLED = false;

    private Debug065122Log() {}
