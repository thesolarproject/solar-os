 ...
 */
public final class PlexCoverArt {
    ...
    private PlexCoverArt() {}

    /** 2026-07-06: Pick song art id, else album id for Subsonic getCoverArt. */
    public static String artIdForSong(PlexSong song, PlexAlbum album) {
    ...
    public static void load(final String coverArtId, final int sizePx, final Listener listener) {
        ...
        final String url = PlexClient.getInstance().getCoverArtUrl(coverArtId, sizePx);
