...
/**
 * 2026-07-14 — Debug session 670453: A5 system IME rejects input / cannot dismiss.
 * Layman: writes a trail of keyboard taps and button presses so we can see why typing dies.
 * Tech: NDJSON to filesDir/SD + HTTP ingest (adb reverse tcp:7642) + host .cursor path when present.
 * Reversal: delete class and #region agent log call sites after fix confirmed.
 */
public final class Debug670453Log {

    private static final String TAG = "SolarDbg670453";
    private static final String SESSION = "670453";
    private static final String FILE = "debug-670453.log";
    /** Host workspace path when the JVM can see the tree (dev machine); ignored on device. */
    private static final String HOST_LOG =
            "/home/deck/Documents/Cursor Workspaces/TheSolarProject/solar/.cursor/debug-670453.log";
    private static final String INGEST =
            "http://127.0.0.1:7642/ingest/033bd1a9-8f26-4d94-8b67-6b91f340fc87";

    /** 2026-07-14 — On while hunting A5 IME input/dismiss; disable after confirmation. */
    public static volatile boolean ENABLED = true;

    private Debug670453Log() {}
