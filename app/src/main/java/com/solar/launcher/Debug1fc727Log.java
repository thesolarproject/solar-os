...
/**
 * 2026-07-14 — Debug session 1fc727: A5 USB enable + landscape dual-pane width.
 * Layman: records why Turn on USB fails and whether landscape menus match Y1 scale.
 ...
 */
public final class Debug1fc727Log {

    private static final String TAG = "SolarDbg1fc727";
    private static final String SESSION = "1fc727";
    private static final String FILE = "debug-1fc727.log";
    private static final String INGEST =
            "http://127.0.0.1:7642/ingest/033bd1a9-8f26-4d94-8b67-6b91f340fc87";

    /** 2026-07-14 — On while hunting A5 USB/layout; disable after confirmation. */
    public static volatile boolean ENABLED = false; // 2026-07-16 — off: sync disk/HTTP on wheel/key paths tanked Y1/Y2 scroll

    private Debug1fc727Log() {}
