...
Gradle dependency caching is handled by `gradle/actions/setup-gradle`. Rockbox-Y1 base firmware zips are cached under `.ci-cache/rockbox-bases` between runs.
